"""
Federated Learning Server for Time-Series Task

Coordinates training and aggregates model updates.
Compatible with both fl_client.py and fl_client_time_series.py.
Handles both classification and time series prediction (regression).
Sample usage at the project root directory: 
[1] python .\fl-time-series\run_fl_system_time_series.py --data-dir .\data\train\gps-imu\
 --config config_regression --learning-mode regression
[2] python .\fl-time-series\run_fl_system_time_series.py --data-dir .\data\train\packets\
...
class FLServerTimeSeries:
    """Federated Learning Server for the Time-Series (classification or regression) Task."""
