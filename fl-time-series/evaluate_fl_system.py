...
Usage (from project root; checkpoint/output default to fl-time-series/):
    python fl-time-series/evaluate_fl_system.py --data-dir data/train/packets --task classification --config config_classification
    python fl-time-series/evaluate_fl_system.py --data-dir data/prepared_clients --task regression --config config_regression
    # Or pass explicitly: --checkpoint-dir fl-time-series/checkpoints --output-dir fl-time-series/evaluation_results
"""
...
# This script lives in fl-time-series/; add it and project root to path for imports
...
from data_preprocessing_time_series import DataPreprocessorTimeSeries
import logging
            ...
            for client_file in client_test_files:
                ...
                try:
                    ...
                    if 'packet' in client_file.lower():
                        preprocessor = DataPreprocessorTimeSeries(
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help='Directory containing model checkpoints (default: fl-time-series/checkpoints)'
    )
    parser.add_argument(
        '--data-dir',
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help='Output directory for evaluation results (default: fl-time-series/evaluation_results)'
    )
    parser.add_argument(
        '--device',
        type=str,
    ...
    # Default checkpoint and output dirs to fl-time-series so they stay in this folder
    if args.checkpoint_dir is None:
        args.checkpoint_dir = os.path.join(SCRIPT_DIR, 'checkpoints')
