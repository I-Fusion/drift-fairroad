...
[1] python .\fl-time-series\run_fl_system_time_series.py --data-dir .\data\train\packets\ --config config_classification --learning-mode classification
[2] python .\fl-time-series\run_fl_system_time_series.py --data-dir .\data\train\gps-imu\ --config config_regression --learning-mode regression
"""
import subprocess
import time
import sys
...
def main():
    ...
    server_script = os.path.join(script_dir, 'fl_server_time_series.py')
    server_cmd = [
    ...
    for i in range(1, NUM_CLIENTS + 1):
        ...
        # Use -u flag to ensure unbuffered output for real-time streaming
        client_script = os.path.join(script_dir, 'fl_client_time_series.py')
        client_cmd = [
