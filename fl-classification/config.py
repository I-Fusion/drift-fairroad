"""
Configuration for Federated Learning System - Classification

This configuration is specifically for classification using only labeled data.
"""
import os
...
def print_config():
    ...
    print(f"  Learning Mode: Classification (Binary)")
    print(f"\nOUTPUT:")
