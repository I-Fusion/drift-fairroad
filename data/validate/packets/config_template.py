...
# Client file mapping:
# Client 0:
#   Packet: .\data\validate\packets\packet_client_000.csv

# Client 1:
#   Packet: .\data\validate\packets\packet_client_001.csv

# Client 2:
#   Packet: .\data\validate\packets\packet_client_002.csv
